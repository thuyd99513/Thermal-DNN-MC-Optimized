...
#=========================================
from Network import l_list, l_S_list, step_list_v2 
...
nsample_list = [i*8 for i in sample_index_list]
...
def print_q(q,index,tw,L,M,N,N_in,N_out,beta,tot_steps_,tot_steps,step_list):
