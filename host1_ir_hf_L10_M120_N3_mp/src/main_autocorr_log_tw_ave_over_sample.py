...
def autocorr_log_ave_over_sample(L=L, M=M, N=N, tot_steps=tot_steps, beta=beta, N_in=N_in, N_out=N_out, tw=tw, n_replica=n_replica,init_list=init_list, inner_representation=False, X_index=1):
