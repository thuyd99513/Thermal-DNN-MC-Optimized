...
from utilities_overlap import num_dof, print_q, plot_ave_overlap_S, plot_ave_overlap_J, errorbar_ave_overlap_S, errorbar_ave_overlap_J 
...
def overlap_log_ave_over_sample(L=L, M=M, N=N, tot_steps=tot_steps, beta=beta, N_in=N_in, N_out=N_out, tw=tw, n_replica=n_replica,init_list=init_list):
    ...
    #========================================================================
    res_J=np.load('{}/{}/overlap_J_{:s}_sample{:d}_tw{:d}_L{:d}_N{:d}_beta{:4.2f}_step{:d}.npy'.format(data_dir,stamp,stamp,main_index,tw,L,N,beta,tot_steps))
    res_S=np.load('{}/{}/overlap_S_{:s}_sample{:d}_tw{:d}_L{:d}_M{:d}_N{:d}_beta{:4.2f}_step{:d}.npy'.format(data_dir,stamp,stamp,main_index,tw,L,M,N,beta,tot_steps))
    ...
    np.save('{}/{}/overlap_J_ave_over_sample_{:s}_tw{:d}_L{:d}_N{:d}_beta{:4.2f}_step{:d}.npy'.format(data_dir,stamp,stamp,tw,L,N,beta,tot_steps),res_J_ave_over_sample)
    np.save('{}/{}/overlap_S_ave_over_sample_{:s}_tw{:d}_L{:d}_M{:d}_N{:d}_beta{:4.2f}_step{:d}.npy'.format(data_dir,stamp,stamp,tw,L,M,N,beta,tot_steps),res_S_ave_over_sample)
    np.save('{}/{}/overlap_std_J_ave_over_sample_{:s}_tw{:d}_L{:d}_N{:d}_beta{:4.2f}_step{:d}.npy'.format(data_dir,stamp,stamp,tw,L,N,beta,tot_steps),std_J_ave_over_sample)
    np.save('{}/{}/overlap_std_S_ave_over_sample_{:s}_tw{:d}_L{:d}_M{:d}_N{:d}_beta{:4.2f}_step{:d}.npy'.format(data_dir,stamp,stamp,tw,L,M,N,beta,tot_steps),std_S_ave_over_sample)
    print("shape of J, and of S:")
    print(res_J.shape)
    print(res_S.shape)
