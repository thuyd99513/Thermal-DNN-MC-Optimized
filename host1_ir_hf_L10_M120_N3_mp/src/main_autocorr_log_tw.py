...
from utilities_autocorr import autocorr_J_hidden_v2, autocorr_S, plot_autocorr_J_hidden, plot_autocorr_S, \
...
def autocorr_log_tw(L=L, M=M, N=N, tot_steps=tot_steps, beta=beta, N_in=N_in, N_out=N_out, tw=tw, sample_index=sample_index, n_replica=n_replica):
