...
# Parameters
#===========
n_replica = 16 # IMPORTANT: FOR  A NEW SYSTEM, PLEASE SET THE n_replica! 
...
def overlap_log_tw(L=L, M=M, N=N, tot_steps=tot_steps, beta=beta, N_in=N_in, N_out=N_out, tw=tw, sample_index=sample_index, n_replica=n_replica):
